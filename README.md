...
Certifique-se de que os arquivos CSV (slife_imoveis.csv, etc.) estão na pasta.
Instale as dependências: pip install -r requirements.txt
Rode a aplicação: streamlit run app.py ou python -m streamlit run app.py
